...
public class DJSeekBarPreference extends Preference
    ...
    public DJSeekBarPreference(
        ...
        a.recycle();
        setLayoutResource(com.android.internal.R.layout.preference_widget_dj_seekbar);
    ...
    final LinearLayout layout = (LinearLayout) LayoutInflater.from(
    		getContext()).inflate(
    				com.android.internal.R.layout.preference_widget_dj_seekbar, null);

    
    TextView mMinValueView = (TextView) layout.findViewById(com.android.internal.R.id.min_value);
    mCurrentValueView = (TextView) layout.findViewById(com.android.internal.R.id.current_value);
    TextView mMaxValueView = (TextView) layout.findViewById(com.android.internal.R.id.max_value);
    ...
    protected void onBindView(View view) {
    	...
    	seekbar = (SeekBar) view.findViewById(
    			com.android.internal.R.id.djseekbar);
