 ...
 * minutes.
 */
public class ClockCenter extends TextView {
	...
	private boolean mShowClockCenter = false;
    ...
    protected void onAttachedToWindow() {
        ...
        if (!mAttached) {
			...
			mPrefs = settingsContext.getSharedPreferences("Junk_Settings", Context.MODE_WORLD_READABLE);
     		...
     		mShowClockCenter = mPrefs.getBoolean(SHOW_CLOCK_CENTER, mShowClockCenter);
        ...
        if (mShowClockCenter) updateClock();
    }
    ...
    private final BroadcastReceiver mIntentReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Junk_Clock_Settings)) {
             	mShowClockCenter = intent.getBooleanExtra(SHOW_CLOCK_CENTER, mShowClockCenter);
            ...
            if (action.equals(Intent.ACTION_TIMEZONE_CHANGED) & mShowClockCenter) {
