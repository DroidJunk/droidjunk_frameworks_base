 ...
 * minutes.
 */
public class ClockLeft extends TextView {
    ...
    private boolean mShowClockLeft = false;
    ...
    protected void onAttachedToWindow() {
        ...
        if (!mAttached) {
			...
			mPrefs = settingsContext.getSharedPreferences("Junk_Settings", Context.MODE_WORLD_READABLE);
     		...
     		mShowClockLeft = mPrefs.getBoolean(SHOW_CLOCK_LEFT, mShowClockLeft);
    ...
    private final BroadcastReceiver mIntentReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Junk_Clock_Settings)) {
             	mShowClockLeft = intent.getBooleanExtra(SHOW_CLOCK_LEFT, mShowClockLeft);
            ...
            if (action.equals(Intent.ACTION_TIMEZONE_CHANGED) & mShowClockLeft) {
